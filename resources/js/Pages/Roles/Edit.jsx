...
export default function EditRole({ role, permissions, rolePermissionIds }) {
    const [form] = Form.useForm();
    const [loading, setLoading] = useState(false);
    const [selectedPermissions, setSelectedPermissions] = useState(rolePermissionIds || []);
            ...
            <Card>
                <div className="mb-6">
                    <Row justify="space-between" align="middle">
                        <Col>
                            <Title level={4} className="m-0">កែប្រែតួនាទី: {role.display_name}</Title>
                        </Col>
                        <Col>
                            <Button
                    ...
                    <Row gutter={24}>
                        <Col xs={24} lg={12}>
                            <Card title="ព័ត៌មានមូលដ្ឋាន" size="small">
                                ...
                                {role.users_count > 0 && (
                                    <Alert
                                        message={`តួនាទីនេះត្រូវបានកំណត់ឱ្យអ្នកប្រើប្រាស់ ${role.users_count} នាក់`}
                                        description="ការផ្លាស់ប្តូរសិទ្ធិនឹងប៉ះពាល់ដល់អ្នកប្រើប្រាស់ទាំងអស់ដែលមានតួនាទីនេះ។"
                                        type="warning"
                                        showIcon
                                    />
                                )}
