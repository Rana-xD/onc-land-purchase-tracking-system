...
import { DownloadOutlined, FileExcelOutlined, FilePdfOutlined, DollarOutlined, FileOutlined, FolderOutlined, CheckCircleOutlined, ClockCircleOutlined } from '@ant-design/icons';
                ...
                {!loading && reportData && reportData.contracts && reportData.contracts.length > 0 && (
                    <div style={{ backgroundColor: '#fff', marginBottom: '24px' }}>
                        ...
                        <Row gutter={16} style={{ backgroundColor: '#fafafa', padding: '12px 16px', borderBottom: '1px solid #f0f0f0', marginBottom: '8px', fontWeight: 'bold' }}>
                            <Col xs={24} sm={4} md={2} style={{ display: 'flex', alignItems: 'center' }}>
                                <Space>
                                    <FileOutlined />
                            ...
                            <Col xs={24} sm={3} md={2} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                <Space>
                                    <CheckCircleOutlined />
                                    <Text>ស្ថានភាព</Text>
                                </Space>
                            </Col>
                            <Col xs={24} sm={3} md={2} style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                                <Space>
                                    <DollarOutlined />
                                    <Text>ចំនួនសរុប</Text>
                                </Space>
