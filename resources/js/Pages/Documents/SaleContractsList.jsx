...
export default function SaleContractsList({ initialDocuments }) {
  ...
  const handleDelete = (id) => {
    router.delete(route('sale-contracts.destroy', { id }), {
      onSuccess: () => {
        message.success('លិខិតទិញ លក់ត្រូវបានលុបដោយជោគជ័យ');
  ...
  return (
    <AdminLayout>
      <Head title="លិខិតទិញ លក់" />
      
      <div className="container mx-auto py-6">
        <Card>
          <div className="flex justify-between items-center mb-6">
            <Title level={3}>បញ្ជីលិខិតទិញ លក់</Title>
            <Space>
              <Input
                placeholder="ស្វែងរក..."
                ...
                style={{ width: 200 }}
              />
              <Link href={route('sale-contracts.create')}>
                <Button type="primary" icon={<PlusOutlined />}>
                  បង្កើតលិខិតទិញ លក់ថ្មី
                </Button>
              </Link>
            </Space>
          </div>
