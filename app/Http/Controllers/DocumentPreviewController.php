...
class DocumentPreviewController extends Controller
{
    ...
    private function generateLandSaleTermsContent(DocumentCreation $document)
    {
        ...
        $content .= 'ភាគី "ខ" យល់ព្រមលក់ដី' . $landCountFormatted . '(' . $landCountKhmer . ')កន្លែងឲ្យភាគី "ក" ជាដីដែលមាន៖';
        ...
        $content .= '<div class="term-content">';
        $content .= 'ភាគី "ខ" យល់ព្រមលក់ដី' . $landCountFormatted . '(' . $landCountKhmer . ')កន្លែងខាងលើ ឲ្យទៅភាគី "ក" ';
        ...
        $content .= '<div class="term-content">';
        $content .= 'ករណីទំហំដីលើប័ណ្ណកម្មសិទ្ធិក្រោយពេលផ្ទេរមកឈ្មោះភាគី "ក" ';
        $content .= 'មានទំហំតូចជាង ឬធំជាងទំហំដីក្នុងប្រកា១.១ ភាគី "ខ" យល់ព្រមឲ្យភាគី "ក" ';
        ...
        $content .= '<div class="term-content">';
        $content .= 'ករណីទំហំដីជាក់ស្តែងតូចជាង ទំហំដីលើប័ណ្ណកម្មសិទ្ធិក្រោយពេលផ្ទេរមកឈ្មោះភាគី "ក" ';
        $content .= 'ដោយសារបាត់បង់ទៅលើព្រំដីអ្នកជិតខាង ភាគី "ខ" យល់ព្រមធ្វើដូចខាងក្រោម៖';
        $content .= '<div class="sub-item">- ទាមទារដីដែលបាត់នោះមកប្រគល់ឲ្យភាគី "ក" មុនពេលទូទាត់ប្រាក់ដំណាក់កាលទី២។</div>';
        $content .= '<div class="sub-item">- ឬមិនទាមទារដីដែលបាត់នោះមកប្រគល់ឲ្យភាគី "ក" ប៉ុន្តែយល់ព្រមឲ្យភាគី "ក" ';
            ...
            return '<div class="payment-schedule-section">
                        <div class="two-column-section">
                            ...
                            <div class="section-content">
                                <div class="content-line">០៦ (ប្រាំមួយ) ខែក្រោយពីចុះកិច្ចសន្យា ភាគី "ក" នឹងបង់ប្រាក់ចំនួន ១.៥០០ ដុល្លារ (មួយពាន់ប្រាំរយ ដុល្លារអាមេរិក) ជូនភាគី"ខ"</div>
                            </div>
                        </div>
                    </div>';
        }
